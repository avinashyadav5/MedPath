        ...
        <ScrollArea className="flex-1 px-4 py-6">
          <nav className="space-y-1">
            {sidebarItems.map((item) => {
              ...
              return (<Link key={item.href} to={item.href} onClick={() => setMobileOpen(false)} className={cn("flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors", isActive ? "bg-violet-600 text-white" : "text-slate-300 hover:bg-slate-800 hover:text-white")}>
