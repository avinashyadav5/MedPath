...
const DiagnosisSchema = z.object({
    ...
    })).optional().describe("Top 3 differential diagnoses with probabilities"),
    reasoning_trace: z.array(z.string()).optional().describe("Step-by-step logical deduction process")
})
